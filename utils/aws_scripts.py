...
def download_object(s3_client, bucket_name, key, download_path, perform_inference=False,
                    ...
                    order_data_thresholds=None, csv_file='results.csv', intervals=None):
    """
    ...
    try:
        ...
        if perform_inference:
            perform_inf(download_path, loc_model=localisation_model, binary_model=binary_model,
                        ...
                        order_data_thresholds=order_data_thresholds, csv_file=csv_file, save_crops=save_crops)
        if remove_image:
...
def download_batch(s3_client, bucket_name, keys, local_path, perform_inference=False,
                   ...
                   country='UK', region='UKCEH', device=None, order_data_thresholds=None, csv_file='results.csv', intervals=None):
    """
    ...
    for key in keys:
        ...
        download_object(s3_client, bucket_name, key, download_path,
                        ...
                        country, region, device, order_data_thresholds, csv_file, intervals)
...
def get_objects(session, aws_credentials, bucket_name, key,
                ...
                binary_model=None,
                order_model=None, order_labels=None, species_model=None, species_labels=None,
               country='UK', region='UKCEH', device=None, order_data_thresholds=None, csv_file='results.csv', crops_interval=None):
    """
